...
export default function Home() {
  return (
    <div className="min-h-[85vh] flex flex-col">
      <div className="flex-1 grid md:grid-cols-[2fr,3fr] gap-12 md:gap-16 py-12 md:py-24">
        <div className="order-2 md:order-1 md:self-start">
        ...
        <div className="order-1 md:order-2 space-y-8">
          <div className="space-y-4">
            <h1 className="animate-slide-down">Ross Dahlke</h1>
            <div className="space-y-2">
              <h2 className="text-[var(--muted)] font-sans text-2xl md:text-3xl font-normal tracking-tight">
                Assistant Professor
              </h2>
