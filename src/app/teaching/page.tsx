...
export default function Teaching() {
  const courses = [
    ...
    {
      code: "J818",
      title: "Computational Approaches for Communication Research",
      semesters: "Fall 2025",
      university: "University of Wisconsin\u2013Madison",
      description: "This course covers computational methods for communication research, including data collection, text analysis, and machine learning approaches applied to media and communication questions.",
      slug: null
    }
  ]
